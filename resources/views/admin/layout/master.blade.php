  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="@yield('seller-class') treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="@yield('all-seller-class')"><a href="{{ route('admin.allseller') }}"><i class="fa fa-circle-o"></i> All Seller</a></li>
            <li class="@yield('add-seller-class')"><a href=""><i class="fa fa-circle-o"></i> Add Seller</a></li>
          </ul>
        </li>
        ...
        <li class="@yield('customer-class') treeview">
          <a href="#">
