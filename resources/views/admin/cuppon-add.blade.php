...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Cuppon page
        <small>add cuppon</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Cuppon</a></li>
        <li class="active">Add cuppon</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box box-info">
            <div class="box-header with-border text-center">
              <h3 class="box-title">Add Cuppon</h3>
              <br>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="{{ route('admin.addcuppon') }}" enctype="multipart/form-data">
              {{ csrf_field() }}
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="Cuppon Code" name="code" placeholder="Cuppon Code" required value="">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="color" name="value" placeholder="Cuppon Value" value="">
                  </div>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="color" name="discription" placeholder="Cuppon Discription" value="">
                  </div>
                </div>
                <!-- /.form-group -->
              </div>
