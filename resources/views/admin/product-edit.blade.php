      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="{{ route('admin.editproduct') }}" enctype="multipart/form-data">
              {{ csrf_field() }}
              <div class="box-body">
                ...
                <div class="form-group">
                   ...
                   <div class="col-sm-9">
                     <select class="form-control select2" id="subcategory" name="subcategory_id" style="width: 100%;" required>
                       <option value="{{ $product->subcategory_id }}"disabled selected>{{ $product->subcategory->name }}</option>
                     </select>
                   </div>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                   ...
                   <div class="col-sm-9">
                     <select class="form-control select2" id="undersubcategory" name="undersubcategory_id" style="width: 100%;">
                       <option value="{{ $product->undersubcategory_id }}" disabled selected>{{ $product->undersubcategory->name }}</option>
                     </select>
                   </div>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                   ...
                   <div class="col-sm-9">
                     <select class="form-control select2" id="brand" name="brand_id" style="width: 100%;">
                       <option value="{{ $product->brand_id }}" disabled selected>{{ $product->brand->name }}</option>
                     </select>
                   </div>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                   ...
                   <div class="col-sm-9">
                     <select class="form-control select2" name="product_condition" style="width: 100%;">
                       <option value="{{ $product->product_condition }}" disabled selected>{{ $product->product_condition }}</option>
                ...
                <div class="form-group">
                   ...
                   <div class="col-sm-9">
                     <select class="form-control select2" name="product_origin" style="width: 100%;">
                       <option value="{{ $product->product_origin }}" disabled selected>{{ $product->product_origin }}</option>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <select class="form-control select2" name="availability" style="width: 100%;">
                      <option value="{{ $product->availability }}" disabled selected>{{ $product->availability }}</option>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <textarea id="return_replacement" name="return_replacement" rows="10" cols="60" required>{{ $product->return_replacement }}</textarea>
                  </div>
                </div>
                <!-- /.form-group -->
